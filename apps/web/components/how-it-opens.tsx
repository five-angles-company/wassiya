...
import { HOW_IT_OPENS } from "@/lib/i18n/strings/how-it-opens"
 ...
 * be a lecture.
 *
 * Shared rather than owned by `features/box`: the case page shows it at the
 * release step, where the heir first learns they need a second half, and the
 * gate shows it again at the moment they use one. Two features, one diagram —
 * and the explanation must be identical in both, or the second reading teaches
...
export function HowItOpens() {
  const labels = t(HOW_IT_OPENS, useLocale())
