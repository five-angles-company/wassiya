...
export const GUARDIAN = {
  metaTitle: { ar: "دعوة وصي · وصيّة", en: "Guardian invitation · Wassiya" },
  ...
  signInFirst: {
    ar: "سجّل الدخول أولاً لنربط الوصاية بحسابك.",
    en: "Sign in first, so the guardianship is tied to your account.",
  },
